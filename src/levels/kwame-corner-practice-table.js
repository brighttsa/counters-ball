...
export const KWAME_CORNER_TABLE = {
  ...
  practice: true,
  name: "Kwame's Corner",
  blurb: 'Kwame shows you how the street plays: pick a cap, flick, hit his chalk ring, bank one off the rail, then find the best view.',
  introLines: ['Practice · six short lessons, about two minutes', 'No flick limit and no score: take your time', 'Quit from the pause menu whenever you like'],
