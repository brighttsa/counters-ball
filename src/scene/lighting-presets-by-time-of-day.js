...
export const LIGHTING_PRESETS = {
  midday: {
    exposure: 1.02, fog: 0xe7c69a, fogRange: [3.0, 16],
    sun: { color: 0xfff0d8, intensity: 3.3, position: [-2.4, 4.6, 1.6] },
  ...
  'late-afternoon': {
    ...
    sun: { color: 0xffbe7d, intensity: 3.1, position: [-4.2, 2.3, 1.1] },
  ...
  'golden-hour': {
    ...
    sun: { color: 0xff9d58, intensity: 3.5, position: [-4.8, 1.45, 0.7] },
